...
Here only 30% of the data is visualised for using the argument `random_sample_frac = 0.3`.
...
Here is the syntax to specify a generic univariate latent change score model
...
The following code shows how to fit a univariate LCS model using the sample data set `data_uni_lcsm`.
...
More detail can be found in the help files `help(fit_bi_lcsm)`.
