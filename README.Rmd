...
The `lcsm` package combines the strengths of other R packages like [lavaan](http://lavaan.ugent.be/), [broom](https://broom.tidyverse.org), and [semPlot](https://CRAN.R-project.org/package=semPlot) by generating `lavaan` syntax that helps these packages work together. 
